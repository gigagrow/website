        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
              GigaGrowth Web Solutions is a provider of custom web design, development, app development, and digital
              marketing services, focusing on tailored solutions to boost your online presence and drive revenue.
            </p>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  ...
                  <span>info@gigagrowthwebsolutions.com</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  <Phone className="h-5 w-5 text-blue-500" />
                  <span>+1 (929) 220-9371</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  <MapPin className="h-5 w-5 text-blue-500" />
                  <span>Lakeland, Miami</span>
                </div>
              </div>
