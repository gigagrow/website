...
const successStories = [
  {
    ...
    testimonial:
      "GigaGrowth Web Solutions transformed our brand from just another local gym to a recognized fitness authority. Their marketing strategy helped us connect with our ideal audience and showcase what makes us different.",
    person: {
      name: "Sarah Johnson",
      role: "Founder & CEO",
  ...
  },
  {
    ...
    testimonial:
      "Before working with GigaGrowth Web Solutions, I was just another artist lost in the noise. Their team understood exactly what made my sound unique and how to get it in front of the right listeners. The growth has been incredible.",
    person: {
      name: "Marcus Webb",
  ...
  },
  {
    ...
    testimonial:
      "GigaGrowth Web Solutions understood the luxury real estate market and helped us communicate our value proposition effectively. Their strategies have directly contributed to our most successful year in business.",
    person: {
      name: "David Chen",
