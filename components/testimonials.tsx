...
const testimonials = [
  {
    ...
    content:
      "GigaGrowth Web Solutions transformed my artistic brand completely. My gallery sales increased by 300% within 6 months of working with them.",
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=60&width=60",
    content:
      "From unknown designer to featured in Vogue - GigaGrowth Web Solutions made it happen. Their brand positioning strategy was game-changing.",
    rating: 5,
  },
]
