          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-8">
                <Link href="/about" className="text-sm text-gray-300 hover:text-pink-400 transition-colors">
                  About
                </Link>
                <Link href="/services" className="text-sm text-gray-300 hover:text-blue-400 transition-colors">
                  Services
                </Link>
                <Link href="/industries" className="text-sm text-gray-300 hover:text-purple-400 transition-colors">
                  Industries
                </Link>
                <Link href="/portfolio" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">
                  Portfolio
                </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-700/50 bg-gray-900/80 backdrop-blur-md rounded-b-2xl">
            <div className="px-6 py-4 space-y-3">
              <Link href="/about" className="block text-gray-300 hover:text-pink-400">
                About
              </Link>
              <Link href="/services" className="block text-gray-300 hover:text-blue-400">
                Services
              </Link>
              <Link href="/industries" className="block text-gray-300 hover:text-purple-400">
                Industries
              </Link>
              <Link href="/portfolio" className="block text-gray-300 hover:text-cyan-400">
                Portfolio
              </Link>
