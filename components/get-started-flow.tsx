  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/submit-form", {
        ...
        body: JSON.stringify({ ...formData, source: "Get Started Flow" }),
      })
      if (response.ok) {
        nextStep()
      }
            ...
            {currentStep === 5 && (
              ...
              >
                ...
                <p className="text-xl text-gray-300 mb-6">
                  Thank you for choosing GigaGrowth Web Solutions. We'll create a custom strategy based on your
                  responses and get back to you within 24 hours.
                </p>
              ...
              <div>
                ...
                {currentStep === 4 && (
                  <AnimatedButton
                    ...
                    className="bg-white text-black hover:bg-gray-100"
                  >
                    {isSubmitting ? "Sending..." : "Complete Setup"}
